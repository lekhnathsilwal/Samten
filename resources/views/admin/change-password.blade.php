            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Change Password <small>Please fill the form to change your password</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <br/>
                                <form action="{{route('update.password')}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    @csrf
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="password_confirmation">Confirm New Password <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
